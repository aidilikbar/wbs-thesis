...
Route::post('/auth/register', [AuthController::class, 'registerReporter'])->middleware('throttle:public-register');
Route::post('/auth/login', [AuthController::class, 'login'])->middleware('throttle:public-login');
Route::post('/auth/logout', [AuthController::class, 'logout']);

Route::post('/tracking', [PublicReportController::class, 'track'])->middleware('throttle:public-tracking');
