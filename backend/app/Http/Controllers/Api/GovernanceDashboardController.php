        ...
        if ($user->role === User::ROLE_SYSTEM_ADMINISTRATOR) {
            ...
            return [
                ...
                'action_items' => [
                    ...
                    [
                        'title' => 'Manage internal user readiness',
                        'detail' => 'Inactive or missing accounts can delay verification and investigation work.',
                        'href' => '/admin',
                        'count' => $inactiveInternalUsers,
                        'tone' => $this->toneForCount($inactiveInternalUsers, 1, 3),
                    ],
                    [
                        'title' => 'Inspect audit trail freshness',
                        'detail' => 'Use recent audit evidence to confirm workflow and control activity remain observable.',
                        'href' => '/governance',
